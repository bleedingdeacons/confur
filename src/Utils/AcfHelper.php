...
class AcfHelper
{
     ...
     */
    public static function updateAcfField($post_id, $field_name, $value)
    {
     ...
     * @return bool True on success, false on failure
     */
    public static function updateAcfFields($post_id, $fields)
    {
     ...
     */
    public static function updateAcfField2($post_id, $field_name, $value)
    {
        if (empty($post_id) || empty($field_name)) {
