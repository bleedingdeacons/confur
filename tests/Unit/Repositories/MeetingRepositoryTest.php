...
class MeetingRepositoryTest extends TestCase
{
    ...
    public function testGetMeetingsMapsPostsAndMeta(): void
    {
        ...
        $GLOBALS['confur_titles'] = [99 => 'Church Hall'];
        $GLOBALS['confur_fields'] = [10 => ['allocated_committee' => '3']];
    ...
    public function testGetMeetingsHandlesCorruptTypesMeta(): void
    {
        ...
        $GLOBALS['confur_postcustom'] = [20 => ['types' => [serialize('a-plain-string')]]];
